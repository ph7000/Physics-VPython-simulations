...
while proton.pos.x < 5.0E-10:
    ...
    r2 = barrow2.pos - proton.pos  # 1. Calculate r and rhat
    r2mag = mag(r2)
    r2hat = r2/r2mag
    B2field = mu0over4pi*qproton*cross(velocity,r2)/(mag(r2)**2)  # 2. Calculate the magnetic field vector
    ...
    proton.pos = proton.pos + velocity*deltat # Update the proton's position
